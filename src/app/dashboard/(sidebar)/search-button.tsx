    ...
    <SidebarMenu>
      <SidebarMenuItem>
        <SidebarMenuButton asChild tooltip="Search">
          <Button
            className="group/kbd after:-inset-4 w-full max-w-sm justify-between gap-21 border border-primary/15 bg-sidebar-accent px-1.5 text-ga-purple-600 shadow-none after:absolute after:content-[''] hover:bg-sidebar-accent hover:text-sidebar-accent-foreground dark:text-ga-purple-300 dark:hover:text-ga-purple-100"
